...
function getLoginConfig(kind: ReturnType<typeof getProductKind>) {
  if (kind === 'directory') {
    return {
      ...
      icon: Building2,
      title: 'Access your classifieds dashboard',
      body: 'Manage your posted ads, responses, and saved searches from one clean local marketplace workspace.',
    }
  }
  if (kind === 'editorial') {
    return {
        ...
        <section className="grid gap-8 lg:grid-cols-[0.88fr_1.12fr] lg:items-stretch">
          <div className={`rounded-[2rem] p-8 ${config.side}`}>
            ...
            <div className="mt-8 grid gap-4">
              {['Quick ad management', 'Faster local buyer-seller flow', 'Trust-focused visual design'].map((item) => (
          ...
          <div className={`rounded-[2rem] p-8 ${config.panel}`}>
            ...
            <AuthFormPanel mode="login" actionClassName={config.action} />
